...
<html lang="ja">
    ...
    <body>
        <center>
            ...
            else if($publisher == "ALL" && $classnum != "ALL"){
                $sql = "
                select book.title, book.publisher, class.classname, book.author1, book.author2, book.author3, publish.pubpage, book.finishdate, book.status 
                from book, publish, class 
                where book.publisher = publish.publisher and book.classnum = class.classnum and book.classnum = '$classnum'";
            }
            else if($publisher != "ALL" && $classnum == "ALL"){
                $sql = "
                select book.title, book.publisher, class.classname, book.author1, book.author2, book.author3, publish.pubpage, book.finishdate, book.status 
                from book, publish, class 
                where book.publisher = publish.publisher and book.classnum = class.classnum and book.publisher = '$publisher'";
            }
            else{
                $sql = "
                select book.title, book.publisher, class.classname, book.author1, book.author2, book.author3, publish.pubpage, book.finishdate, book.status  
                from book, publish, class 
                where book.publisher = publish.publisher and book.classnum = class.classnum and book.publisher = '$publisher' and book.classnum = '$classnum'";
            }
